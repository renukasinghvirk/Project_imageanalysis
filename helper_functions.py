...
def project_extract_circles_with_transparency(img_path, detected_circles, scale_factor, desired_radius = 400, show = False):
    """
...
def project_classify_picture(image):
    """
    ...
    if hue_std > 50 :
        return "hand"
    elif hue_std > 30 and hue_std <= 45:
        return "noisy"
    else:
        return "neutral"
